...
def emitir_y_guardar_factura(*, client, amount, pto_vta: int, cbte_tipo: int,
                             doc_tipo: int, doc_nro: str, condicion_iva_receptor_id: int|None=5):
    result = fe.solicitar_cae(
        cuit="TU_CUIT_EMISOR",
        pto_vta=pto_vta,
        importe=amount,
        cbte_tipo=cbte_tipo,
